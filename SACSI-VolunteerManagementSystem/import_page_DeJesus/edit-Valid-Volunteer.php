...
<head>
  ...
  <title>Database Management - Edit Valid Student Volunteer Data</title>
  ...
  <style>
    ...
    *{ 
    ...
    .checkbox-wrapper {
        ...
        align-items: center;      /* keeps label aligned with checkbox */
        gap: 0.5rem;              /* space between checkbox and label */
        margin-top: 1rem;         /* optional: spacing from other inputs */
        margin-bottom: 1rem;
    }
...
<body>
    ...
    <header class="database-header">
        <div class="header-content">    
            <button class="back-button" onclick="window.location.href='../import_page_DeJesus/import'">
          ...
          <main class="database-main">
            <div class="edit-section" role="region" aria-label="Edit Volunteer">
              ...
              <div class="input-grid">
                <div class="volunteer-info"><input type="text" class="form-control" id="Volunteer-Fullname" placeholder="Fullname"></div>
                <div class="volunteer-info"><input type="text" class="form-control" id="Volunteer-IDNumber" placeholder="ID Number"></div>

                <div class="volunteer-info"><input type="text" class="form-control" id="Volunteer-Course" placeholder="Course"></div>
                <div class="volunteer-info"><input type="text" class="form-control" id="Volunteer-Year" placeholder="Year"></div>

                <div class="volunteer-info"><input type="tel" class="form-control" id="Volunteer-Contact" placeholder="Contact number"></div>
                <div class="volunteer-info"><input type="tel" class="form-control" id="Volunteer-Emg" placeholder="Emergency number"></div>

                <div class="volunteer-info"><input type="email" class="form-control" id="Volunteer-Email" placeholder="Email"></div>
                <div class="volunteer-info"><input type="url" class="form-control" id="Volunteer-FBLink" placeholder="Facebook profile link"></div>

                <div class="volunteer-info"><input type="text" class="form-control" id="Volunteer-Barangay" placeholder="Barangay"></div>
            </div>
